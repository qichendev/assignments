...
ALTER TABLE
    RP_PRODUCTS
MODIFY
    PRODUCT_DESCRIPTION VARCHAR2(100) UNIQUE;

ALTER TABLE
    RP_INVENTORY
ADD
    CONSTRAINT fk_wharehouse_id FOREIGN KEY (wharehouse_id) REFERENCES RP_WAREHOUSE(wharehouse_id);

ALTER TABLE
    RP_INVENTORY
ADD
    CONSTRAINT fk_product_id FOREIGN KEY (product_id) REFERENCES RP_PRODUCTS(product_id);

ALTER TABLE
    RP_CUSTOMERS
ADD
    CONSTRAINT fk_rep_id FOREIGN KEY (rep_id) REFERENCES RP_REPS(rep_id);
...
ALTER TABLE
    RP_ORDER_ITEMS
ADD
    CONSTRAINT fk_order_id FOREIGN KEY (order_id) REFERENCES RP_ORDERS(order_id);

ALTER TABLE
    RP_ORDERS
ADD
    CONSTRAINT fk_consumer_id FOREIGN KEY (consumer_id) REFERENCES RP_CUSTOMERS(consumer_id);