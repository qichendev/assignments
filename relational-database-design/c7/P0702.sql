...
ALTER TABLE RP_INVENTORY
    MODIFY WAREHOUSE_ID NUMBER NOT NULL;
ALTER TABLE RP_INVENTORY
    MODIFY PRODUCT_CODE VARCHAR2(10) NOT NULL;
ALTER TABLE RP_INVENTORY
    MODIFY QOH NUMBER NOT NULL;

CREATE TABLE RP_WAREHOUSE
    MODIFY WAREHOUSE_ID NUMBER NOT NULL;
CREATE TABLE RP_WAREHOUSE
    MODIFY WHSE_CITY VARCHAR2(10) NOT NULL;
...
CREATE TABLE RP_CUSTOMERS
    MODIFY STREET VARCHAR2(100) NOT NULL;
CREATE TABLE RP_CUSTOMERS
    MODIFY CUST_CITY VARCHAR2(50) NOT NULL;
CREATE TABLE RP_CUSTOMERS
    MODIFY CUST_STATE VARCHAR2(50) NOT NULL;
CREATE TABLE RP_CUSTOMERS
    MODIFY ZIP VARCHAR2(10) NOT NULL;
CREATE TABLE RP_CUSTOMERS
    MODIFY BALANCE NUMBER NOT NULL;
CREATE TABLE RP_CUSTOMERS
    MODIFY CREDIT_LIMIT NUMBER NOT NULL;
CREATE TABLE RP_CUSTOMERS
    MODIFY REP_ID NUMBER NOT NULL;
...
CREATE TABLE RP_REPS
    MODIFY STREET VARCHAR2(100) NOT NULL;
CREATE TABLE RP_REPS
    MODIFY REP_CITY VARCHAR2(50) NOT NULL;
CREATE TABLE RP_REPS
    MODIFY REP_STATE VARCHAR2(50) NOT NULL;
CREATE TABLE RP_REPS
    MODIFY ZIP VARCHAR2(10) NOT NULL;
CREATE TABLE RP_REPS
    MODIFY COMMISSION NUMBER NOT NULL;
CREATE TABLE RP_REPS
    MODIFY RATE NUMBER NOT NULL;

CREATE TABLE RP_ORDER_LINES
    MODIFY ORDER_ID NUMBER NOT NULL;
CREATE TABLE RP_ORDER_LINES
    MODIFY PRODUCT_CODE VARCHAR2(10) NOT NULL;
CREATE TABLE RP_ORDER_LINES
    MODIFY QTY_ORDERED NUMBER NOT NULL;
CREATE TABLE RP_ORDER_LINES
    MODIFY PRICE_PAID NUMBER NOT NULL;
...
CREATE TABLE RP_PRODUCTS
    MODIFY PRODUCT_CODE VARCHAR2(10) NOT NULL;
CREATE TABLE RP_PRODUCTS
    MODIFY PRODUCT_DESCRIPTION VARCHAR2(100) NOT NULL;
CREATE TABLE RP_PRODUCTS
    MODIFY PRODUCT_CATEGORY VARCHAR2(50) NOT NULL;
CREATE TABLE RP_PRODUCTS
    MODIFY COST_PRICE NUMBER NOT NULL;