...
-- views
-- 1.1
CREATE OR REPLACE VIEW C15V1 AS
    ...
    WHERE e.hire_date > '2008-01-01'
    ORDER BY DEPT_NAME, LNAME;

-- 1.2
SELECT *
FROM C15V1
WHERE DEPT_NAME IN ('Home Theatre', 'Video Games')
ORDER BY DEPT_NAME, LNAME;
...
ON d.department_code = e.department_code
WHERE e.hire_date > '2008-01-01'
    AND d.department_name IN ('Home Theatre', 'Video Games')
ORDER BY DEPT_NAME, LNAME;

-- 2.1
CREATE OR REPLACE VIEW C15V2 AS
...
SELECT EMPLOYEE_NAME
    , TO_CHAR(MAX_SALARY, '$999,999.99') AS MAX_SALARY
    , TO_CHAR(YEARLY_SALARY, '$999,999.99') AS YEARLY_SALARY
...
-- 4.3
SELECT DEPT_NAME
    , TO_CHAR(AVGERAGE_SALARY, '$999,999.99') AS AVGERAGE_SALARY
FROM C15V4
